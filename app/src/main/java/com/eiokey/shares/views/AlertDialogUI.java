package com.eiokey.shares.views;
...
/**
 * @author JetQiao @Email:qiaoy@cwintop.com AlertDialogUI.java TODO
 * @Date 2015年5月28日
 */
public class AlertDialogUI
{
    ...
    public AlertDialogUI(Context context)
    {
        ...
        try
        {
            ...
            View layout = inflater.inflate(R.layout.ui_alertdialog, null);
            ...
            ad.setContentView(layout, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
     ...
     * @param listener
     */
    public void setNegativeButton(String text, boolean bool, final View.OnClickListener listener)
    {
